...
public:
  ...
  IntegratorBaseSparse(int r, double timestep, SparseMatrix * massMatrix, ForceModel * forceModel, int numConstrainedDOFs=0, int * constrainedDOFs=NULL, int numDynamicConstrainedDOFs=0, int * DynamicConstrainedDOFs=NULL, double dampingMassCoef=0.0, double dampingStiffnessCoef=0.0);
...
protected:
  ...
  int * DynamicConstrainedDOFs;
  int * newDynamicCTIndices; 
  int numTotConstrainedDOFs;
  int * TotConstrainedDOFs;
