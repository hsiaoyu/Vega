...
EulerSparse::EulerSparse(int r, double timestep, SparseMatrix * massMatrix_, ForceModel * forceModel_, int symplectic_, int numConstrainedDOFs_, int * constrainedDOFs_, int numDynamicConstrainedDOFs_, int * DynamicConstrainedDOFs_, double dampingMassCoef, int numSolverThreads): IntegratorBaseSparse(r, timestep, massMatrix_, forceModel_, numConstrainedDOFs_, constrainedDOFs_,numDynamicConstrainedDOFs_, DynamicConstrainedDOFs_,  dampingMassCoef, 0.0), symplectic(symplectic_)
{
