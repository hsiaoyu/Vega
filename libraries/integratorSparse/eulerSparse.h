...
public:
  ...
  EulerSparse(int r, double timestep, SparseMatrix * massMatrix, ForceModel * forceModel, int symplectic=0, int numConstrainedDOFs=0, int * constrainedDOFs=NULL, int numDynamicConstrainedDOFs=0, int * DynamicConstrainedDOFs=NULL, double dampingMassCoef=0.0, int numSolverThreads=1);
